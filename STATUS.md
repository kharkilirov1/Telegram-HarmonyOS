...
- **Phase:** R1/R1.5+ — сверх плана добиты крупные пласты: поиск по чату E2E (вход/извлечение/навигация «N of M»/подсветка), jump-to-message (окно вокруг цели, обе кромки пагинации), scroll-to-bottom FAB, jump-потребители (reply-снипет, Shared Media→чат), черновики E2E, UI-волны (плоский iOS таб-бар, телеграмные иконки Settings, чистка Contacts). Витнесс Play/Pause войса ЗАКРЫТ на экране. Гейты пользователя прежние: догфуд (R1), приёмка внешки (R1.5), сертификат+release (R2)
- **Direction:** минимальный релизный клиент v0.1.0 → фичи маленькими обновлениями v0.x
- **Last committed baseline:** `9116533` (тик 47: черновики E2E + урок полного датапути)
