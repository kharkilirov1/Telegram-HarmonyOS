...
- [ ] **[P3 CONFIRMED] Divider «Не прочитано» не строится в группах**: канал — divider есть и открытие ровно на нём; группа Huawei HarmonyOS со 140+ unread открылась на unread-якоре (00:43 при новейших 04:24 — якорь РАБОТАЕТ), но divider отсутствует в дереве. Искать в ChatTimelineVO: условие вставки 'unread'-entry (lastReadInboxMessageId-сравнение), вероятно, не срабатывает для групп
...
- [ ] **[P4-c follow-up] Root cause id-mismatch**: выяснить, почему fileId контента в сторе расходится с fileId `updateFile` (пере-нумерация TDLib vs. подмена сообщений новыми страницами истории); трассы `DownloadMedia: enqueue` и `FilesReducer: fileDownloaded` оставлены в коде. После фикса — убрать transfers-фоллбэк или оставить как страховку, трейсы понизить/удалить
...
- [ ] **R1.5 (новый гейт, см. план): дефект-лист внешки** — согласовать с пользователем до правок. Стартовые наблюдения со скриншотов эмулятора (2026-07-03):
  - Топ-бар чата: тайтл в «пилюле» с рамкой — у Telegram чистый текст+статус по центру без капсулы; back-кнопка в отдельном круге
  - Композер: кнопки скрепки/микрофона — крупные залитые круги, поле «Сообщение» пилюлей на всю ширину; у Telegram — плоские иконки без кругов и компактнее по высоте
  - Нижние табы: системные SF-иконки HdsTabs без бейджа непрочитанного на вкладке Chats (у Telegram — бейдж на табе)
  - Чат-лист: разделители между ячейками на всю ширину (у Telegram — от текстовой колонки), нет свайп-экшенов
  - Медиа: download-плейсхолдер — тёмный круг с квадратной иконкой, у Telegram — тонкое кольцо прогресса + blur-minithumbnail фоном (minithumbnail не рендерится вовсе)
  - Пузыри: нет хвостиков (tails) у крайних сообщений группы; реакции не отображаются
