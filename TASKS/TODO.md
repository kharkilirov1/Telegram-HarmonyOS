...
- [ ] **R1.5: дефект-лист внешки** (разрешение пользователя получено — «разрешаю все»; прогресс 2026-07-03):
  ...
  - [x] Медиа-плейсхолдер (`6b1fef4`): blur-minithumbnail из TDLib для фото/альбомов по всем трём путям рендера (router/shell/page); кольцо прогресса уже существовало в TgPhotoBubble. Follow-up: minithumb для видео/анимаций (парсер ещё не извлекает)
