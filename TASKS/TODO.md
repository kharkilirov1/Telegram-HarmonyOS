...
- [ ] Композер-полиш дальше: рост поля при многострочном вводе (проверить maxLines/анимация), панель эмодзи бедновата vs Telegram, тап-фидбек кнопок (scale/opacity), кнопка камеры рядом с микрофоном (iOS)
